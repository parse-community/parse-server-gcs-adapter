...
// index.ts
var parse_gcs_exports = {};
__export(parse_gcs_exports, {
  default: () => parse_gcs_default
});
module.exports = __toCommonJS(parse_gcs_exports);
...
var GCSAdapter = class {
  constructor(...args) {
    ...
    this._gcsClient = new import_storage.Storage(options);
  }
